...
### 프리미어리그 데이터 불러오기
pl = pd.read_excel("C:/Users/skybl/Desktop/프리미어리그 스쿼드/분석데이터/프리미어리그_포지션.xlsx")
...
### K리그 데이터 불러오기
kl = pd.read_excel("C:/Users/skybl/Desktop/프리미어리그 스쿼드/분석데이터/K리그_포지션.xlsx")
...
data = pd.read_excel("C:/Users/skybl/Desktop/월드컵 데이터/2018러시아/2018월드컵.xlsx")
